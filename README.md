...
.forEach is an array method that _does something_ to each item of an array but has no return value.
.map is an array method that _does something_ to each item of an array and returns a new array.
...
super() is what binds the this keyword to the parent class attributes for the child class.
