...
const lessThan5 = zooAnimals.filter(item => item.population < 5);
largerPopulation.push(...lessThan5);
//I'm not sure why the question asks for the population that is less than 5, then makes an empty array called largerPopulation...?
